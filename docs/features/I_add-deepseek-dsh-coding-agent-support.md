...
updated_at: "2026-09-11T22:42:46.506Z"
---
...
| WBS | Task | Status |
| --- | ---- | ------ |
| 0066 | Add deepseek dsh shim to ts-ai-runner | backlog |
| 0067 | Add deepseek session source to ts-llm-jsonl-importer | backlog |
<!-- END AUTO-GENERATED -->
