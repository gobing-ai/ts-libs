...
updated_at: "2026-09-23T16:35:39.951Z"
---
...
| WBS | Task | Status |
| --- | ---- | ------ |
| 0083 | Add the fm text-only agent shim to ts-ai-runner | todo |
| 0084 | Create the ts-decision-fm package with the sampling fm-local driver | todo |
| 0085 | Wire the fm-local backend selector, boundary rules and docs | todo |
<!-- END AUTO-GENERATED -->
