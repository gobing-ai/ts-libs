...
[backlog] **A**: ts-ai-runner ([A_ts-ai-runner.md](./A_ts-ai-runner.md))
    ...
    └── [verifying] **A2**: Provider-neutral DecisionMaker over TypeSafe Jev in ts-ai-runner ([A2_provider-neutral-decisionmaker-over-typesafe-jev-in-ts-ai-runner.md](./A2_provider-neutral-decisionmaker-over-typesafe-jev-in-ts-ai-runner.md))
